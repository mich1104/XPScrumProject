        ...
        for (Student student : studentlist) {
            ...
            if (!poolA.isEmpty()) {
                for (Subject subject : poolA) {
                    if (subject.getTitle().equals(firstPrio[0].getTitle()) || subject.getTitle().equals(firstPrio[1].getTitle()) || subject.getTitle().equals(firstPrio[2].getTitle())) {
                        if (!poolAset) {
                            if (!firstGradeSet) {
                                firstGradeSet = true;
                                poolAset = true;
            ...
            if (!poolB.isEmpty()) {
                ...
                if (!firstGradeSet || !secondGradeSet || !thirdGradeSet) {
                    if (!poolA.isEmpty()) {
                        ...
                        if (!poolAset) {
                            for (Subject subject : poolA) {
                                if (subject.getTitle().equals(secondPrio[0].getTitle()) || subject.getTitle().equals(secondPrio[1].getTitle()) || subject.getTitle().equals(secondPrio[2].getTitle())) {
                                    if (!poolAset) {
                                        if (!firstGradeSet) {
                                            firstGradeSet = true;
                                            poolAset = true;
